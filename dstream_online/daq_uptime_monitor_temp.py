...
class daq_uptime_monitor(ds_project_base):
    ...
    def process_newruns(self):
        ...
        plt.grid()
        plt.show()
        plt.savefig('%s/data/UpTimeLong_yuntse.png' % os.environ['PUB_TOP_DIR'])
...
#        values   = values[0:25]
        ...
        plt.grid()
        plt.show()
        plt.savefig('%s/data/UpTimeShort_yuntse.png' % os.environ['PUB_TOP_DIR'])
        ...
        plt.grid()
        plt.show()
        plt.savefig('%s/data/UpTimeLongDaily_yuntse.png' % os.environ['PUB_TOP_DIR'])
    ...
    def make_html(self):
        ...
        <figure>
        <td>
        <img src="UpTimeShort_yuntse.png" alt="DAQ UpTime (Hourly, 24 hour)" style="width:600px;height:400px;" border="2"/>
        <center><figcaption><font size=4 color="0080ff"><b> DAQ UpTime (Hourly, Last 24 Hours) </b></font></figcaption></center>
        </td>
        <td>
        <img src="UpTimeLong_yuntse.png" alt="DAQ UpTime (Hourly, 7 days)" style="width:600px;height:400px;" border="2"/>
        <center><figcaption><font size=4 color="0080ff"><b> DAQ UpTime (Hourly, Last 7 days) </b></font></figcaption></center>
        </td>
        <td>
        <img src="UpTimeLongDaily_yuntse.png" alt="DAQ UpTime (Daily, 24 hour)" style="width:600px;height:400px;" border="2"/>
        ...
        """
        fout=open('%s/data/RunStat_yuntse.html' % os.environ['PUB_TOP_DIR'],'w')
